...
const Register = () => {
  ...
  return (
    <div className="bg-white w-full h-full fixed top-0 z-50">
    <div className="font-sans bg-white max-w-4xl mx-auto flex items-center md:h-screen p-4">
      <div className="grid md:grid-cols-3 items-center shadow rounded-xl overflow-hidden">
        <div className="flex flex-col justify-center h-full space-y-16 bg-gradient-to-r from-gray-900 to-gray-700 lg:px-8 px-4 py-4">
          <div>
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  type="text"
                  className={`text-gray-800 bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded-md outline-blue-500 ${errors.username ? 'border-red-500' : ''}`}
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  type="email"
                  className={`text-gray-800 bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded-md outline-blue-500 ${errors.email ? 'border-red-500' : ''}`}
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  type="password"
                  className={`text-gray-800 bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded-md outline-blue-500 ${errors.password ? 'border-red-500' : ''}`}
